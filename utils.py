...
def calculate_tfpn(edge_predictions, edge_labels):
    ...
    print("THESE ARE EDGE PREDICTIONS and their lenght")
    print(edge_predictions)
    print(edge_predictions.shape)
    print("Number of zeros predictions")
    print((edge_predictions == 0).sum().item())
    print("Number of ones predictions")
    print((edge_predictions == 1).sum().item())
    print("THESE ARE EDGE LABELS (without rounding)")
    print(edge_labels)
    print("THESE ARE EDGE LABELS (with rounding)")
    edge_labels = torch.round(edge_labels)
    print(edge_labels)
    print(edge_labels.shape)
    print("Number of zeros labels")
    print((edge_labels == 0).sum().item())
    print("Number of ones predictions")
    print((edge_labels == 1).sum().item())
